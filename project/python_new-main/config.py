...
class Config:
    ...
    OLLAMA_TIMEOUT: int = int(os.getenv('OLLAMA_TIMEOUT', '45'))  # Increased for better AI responses
    OLLAMA_CONNECTION_TIMEOUT: int = int(os.getenv('OLLAMA_CONNECTION_TIMEOUT', '15'))  # Connection timeout
    OLLAMA_READ_TIMEOUT: int = int(os.getenv('OLLAMA_READ_TIMEOUT', '45'))  # Read timeout for responses
